...
function Footer() {
    return (
        <div className="flex flex-col gap-12 mt-8 mb-28 items-center lg:mt-24">
            <button className="tracking-tight border-2 px-5 py-3 border-stone-900 text-xs hover:bg-stone-900 hover:text-white transition-colors duration-250 lg:text-sm">FOLLOW SALON ON FACEBOOK</button>
            <Gallery />
